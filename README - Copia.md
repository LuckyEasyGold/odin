<div align="center">
  ...
  <p>
    ...
    <img alt="Version" src="https://img.shields.io/badge/versão-2.4.0-orange?style=for-the-badge">
  </p>

  <br/>
  <img src="./public/uploads/profile/whodo2.jpeg" alt="WhoDo! Preview" width="100" />
  <img src="./public/uploads/profile/whodo1.jpeg" alt="WhoDo! Preview" width="100" />
  <img src="./public/uploads/profile/whodo3.jpeg" alt="WhoDo! Preview" width="100" />
  </div>
...
| 💬 Mensageria instantânea (Chat) com Espelhamento de Negociação | ✅ Completo |
...
- **Atualizações Recentes (v2.3.0):**
  - **Checkout Híbrido:** Integração avançada do Mercado Pago (via `createPreference`) com a Carteira do sistema (Escrow). Permite abater o saldo disponível da carteira e pagar apenas a diferença no Pix ou Cartão.
  - **Calendário Inteligente (Time-slots):** Agora é possível múltiplos agendamentos no mesmo dia para o mesmo prestador, bloqueando apenas os horários conflitantes.
  - **Avaliações Bilaterais:** Após a conclusão de um agendamento, tanto o Cliente quanto o Prestador podem se avaliar mutuamente através de modais interativos (1 a 5 estrelas).
- **Negociação Unificada no Chat (v2.4.0):** Integração do `AgendamentoCard` diretamente na timeline do chat. Permite aceitar, sugerir datas, pagar e avaliar serviços sem sair da conversa, com limpeza automática do card após a conclusão do processo.
- **API Unificada de Agendamentos (v2.2.0):** Todas as ações do ciclo de vida de um agendamento passam por um único endpoint `/api/agendamento/[id]/acoes`.
- **Máquina de Estados Bidirecional:** O status de um agendamento e orçamentos suporta retornos de estado (como *retomar_servico* ou *sugerir_nova_data* por ambas as partes).
...
- **[WHODO_KNOWLEDGE_BASE.md](./WHODO_KNOWLEDGE_BASE.md)** — Base de conhecimento unificada com tudo sobre o projeto (v2.3.0)
